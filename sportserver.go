...
func main() {
	var sportsList ["Boy's Waterpolo", "Girl's Waterpolo", "Football", "Baseball", "Swimming", "Boy's Basketball", "Girl's Basketball", "Boy's Tennis", "Girl's Tennis","Ultimate Frisbee","Girl's Soccer", "Boy's Soccer", "Girl's Squash", "Boy's Squash", "Girl's Volleyball", "Boy's Volleyball","Cross Country", "Track"]
	var locations ["Old Gym","New Gym","Pool","Upper Field","Lower Field","Tennis Courts"]
	var latitude = double 
